...
<head>
    ...
    <!-- SITE TITLE -->
    <title>Hi Talks Series</title>
    <meta name="description" content="Hi Talks Series 2021"/>
    <meta name="keywords" content="Hi Talks, HiTalks, HMTI, UDINUS"/>
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <div class="lgx-nav-right navbar-right">
                            <div class="lgx-cart-area">
                                <a class="lgx-btn lgx-btn-red" href="#registration"><span>Registration</span></a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-7">
                        <div class="lgx-about-content-area">
                            <div class="lgx-heading">
                                <h2 class="heading">What is Hi Talks?</h2>
                    ...
                    <div class="col-sm-12 col-md-5">
                        <div class="lgx-about-img-sp">
                            <img src="<?= base_url(); ?>/assets/img/poster2.png" alt="poster">
                        </div>
                    </div>
                </div>
            </div><!-- //.CONTAINER -->
            ...
            <div class="container">
                ...
                <div class="lgx-footer-bottom">
                    <div class="lgx-copyright">
                        <p> <span>©</span> 2021 HMTI UDINUS.</p>
                    </div>
                </div>
